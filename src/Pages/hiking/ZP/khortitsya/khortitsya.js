...
import Picture1 from '../../../../assets/hiking-img/ZP/khortitsya/khortitsya1.jpeg';
import Picture2 from '../../../../assets/hiking-img/ZP/khortitsya/khortitsya2.jpeg';
import Picture3 from '../../../../assets/hiking-img/ZP/khortitsya/khortitsya3.jpeg';
import Picture4 from '../../../../assets/hiking-img/ZP/khortitsya/khortitsya4.jpeg';
import Picture5 from '../../../../assets/hiking-img/ZP/khortitsya/khortitsya5.jpeg';
import Picture6 from '../../../../assets/hiking-img/ZP/khortitsya/khortitsya6.JPG';
...
const Khortitsya = () => {
    const { t } = useTranslation(["khortitsya", "translation"]);

    return (
        <Container>
            <h3 className='margin-50'>{t("khortitsya:description.part1")}</h3>
            <Row>
                <Col md='9'>
                    <Row>
                        <Col md='7'>
                            <p className='text-left'>{t("khortitsya:description.part2")}</p>
                        </Col>
                        ...
                        <Col md='12'>
                            <div className='gallary-text mb-4'>
                                ...
                                <p className='justify'>{t("khortitsya:description.part3")}</p>
                                <p className='justify'>{t("khortitsya:description.part4")}</p>
                                <p className='justify'>{t("khortitsya:description.part5")}</p>
                                <p className='justify'>{t("khortitsya:description.part6")}</p>

                                <Row className='hike-info font-italic'>
                                    <Col md='10' className='justify'>
                                    <p className='mb-1'><b>{t("translation:description.part12")}:</b></p>
                                    <ul className='green-point'>
                                            <li><span>{t("khortitsya:description.part9")}</span></li>
                                            <li><span>{t("khortitsya:description.part10")}</span></li>
                                            <li><span>{t("khortitsya:description.part11")}</span></li>
                                            <li><span>{t("khortitsya:description.part12")}</span></li>
                                        </ul>

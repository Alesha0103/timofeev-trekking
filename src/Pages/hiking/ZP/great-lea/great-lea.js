...
import Picture1 from '../../../../assets/hiking-img/ZP/great-lea/great-lea1.JPG';
import Picture2 from '../../../../assets/hiking-img/ZP/great-lea/great-lea2.JPG';
import Picture3 from '../../../../assets/hiking-img/ZP/great-lea/great-lea3.jpg';
import Picture4 from '../../../../assets/hiking-img/ZP/great-lea/great-lea4.jpg';
import Picture5 from '../../../../assets/hiking-img/ZP/great-lea/great-lea5.jpg';
import Picture6 from '../../../../assets/hiking-img/ZP/great-lea/great-lea6.jpg';
...
const GreatLea = () => {
    const { t } = useTranslation(["great-lea", "translation"]);

    return (
        <Container>
            <h3 className='margin-50'>{t("great-lea:description.part1")}</h3>
            <Row>
                <Col md='9'>
                    <Row>
                        <Col md='7'>
                            <p className='text-left'>{t("great-lea:description.part2")}</p>
                        </Col>
                        ...
                        <Col md='12'>
                            <div className='gallary-text mb-4'>
                                ...
                                <p className='justify'>{t("great-lea:description.part3")}</p>
                                <p className='justify'>{t("great-lea:description.part4")}</p>
                                <p className='justify'>{t("great-lea:description.part5")}</p>
                                ...
                                <Row className='hike-info font-italic'>
                                    <Col md='6'>
                                        ...
                                        <ul className='green-point'>
                                            <li><span>{t("great-lea:description.part6")}</span></li>
                                            <li><span>{t("great-lea:description.part7")}</span></li>
                                            <li><span>{t("great-lea:description.part8")}</span></li>
                                            <li><span>{t("great-lea:description.part9")}</span></li>
                                        </ul>
                                    </Col>
